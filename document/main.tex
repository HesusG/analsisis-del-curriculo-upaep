...
\textbf{Estado Actual (SER)} & \textbf{Propuesta (DEBER SER)} \\
\midrule
Examen conceptual (100\% de OA2): opción múltiple y respuesta corta sobre capítulos del libro. & \textcolor{red}{Examen conceptual reducido al 40\%: preguntas esenciales que evalúen comprensión, no memorización.} \\
\midrule
...
\subsection{Elementos que Considero Anticuados pero No Sé Cómo Cambiar}

Debo confesar que hay aspectos del currículum actual que me parecen desactualizados, pero no tengo claridad sobre cómo modificarlos sin romper la coherencia del diseño institucional:

\begin{itemize}
    \item \textbf{El examen conceptual (Objeto 2)}: Evaluar memorización de capítulos de un libro me parece poco alineado con el desarrollo de competencias. Sin embargo, es parte del diseño oficial y no sé cómo proponer una alternativa que sea aceptada institucionalmente.

    \item \textbf{La dependencia de casos ficticios}: El currículum trabaja con ``mini casos'' simulados. Idealmente, los estudiantes trabajarían con problemas reales de empresas locales, pero esto requiere gestión de socios formadores que excede mi capacidad actual.

    \item \textbf{La ausencia de reflexión crítica}: Aunque propongo agregar preguntas reflexivas, siento que son parches superficiales. Una verdadera integración del enfoque de \citet{Apple1979} requeriría repensar todo el currículum desde sus fundamentos, algo que está fuera de mi alcance en este momento.
\end{itemize}

\subsection{Justificación Teórica de los Cambios}

Los cambios propuestos se fundamentan en la integración de tres marcos teóricos complementarios. Esta sección detalla cómo cada elemento de la propuesta se alinea con estos fundamentos.
